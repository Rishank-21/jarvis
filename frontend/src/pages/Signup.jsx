  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="w-[90%] h-[650px] max-w-[500px] bg-[#1E293B]/80 backdrop-blur-xl shadow-2xl shadow-[#00D9FF]/20 flex flex-col items-center justify-center gap-[20px] px-[20px] rounded-3xl border border-[#00D9FF]/30 relative z-10"
      >
        <h1 className="text-white text-[30px] font-bold mb-[30px]">
          Register to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00D9FF] to-[#B026FF]">Jarvis</span>
        </h1>
